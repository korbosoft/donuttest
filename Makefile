...
#---------------------------------------------------------------------------------
LIBS	:=	-lwiiuse -lbte -lgrrlib -lpngu `$(PREFIX)pkg-config freetype2 libpng libjpeg --libs` -lfat -lmodplay -laesnd -logc -lm
...
export OFILES_BIN	:=	$(addsuffix .o,$(BINFILES)) $(addsuffix .o,$(TPLFILES)) $(addsuffix .o,$(QOIFILES)) $(addsuffix .o,$(LIYABCFILES)) $(addsuffix .o,$(ZTPLFILES))
export OFILES_SOURCES   :=      $(CPPFILES:.cpp=.o) $(CFILES:.c=.o) $(sFILES:.s=.o) $(SFILES:.S=.o)
export OFILES           :=      $(OFILES_BIN) $(OFILES_SOURCES)

export HFILES := $(addsuffix .h,$(subst .,_,$(BINFILES))) $(addsuffix .h,$(subst .,_,$(TPLFILES))) $(addsuffix .h,$(subst .,_,$(QOIFILES))) $(addsuffix .h,$(subst .,_,$(LIYABCFILES))) $(addsuffix .h,$(subst .,_,$(ZTPLFILES)))
